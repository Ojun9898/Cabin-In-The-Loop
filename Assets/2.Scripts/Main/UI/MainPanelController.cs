...
public class MainPanelController : MonoBehaviour
{
    ...
    public void OnSceneLoaded()
    {
        ...
        cavin.SetActive(true);
        cavin.GetComponent<SpriteRenderer>().DOFade(0, 0);
        cavin.GetComponent<SpriteRenderer>().DOFade(1, 0.5f);

        // Title 등장 (FadeIn)
        title.SetActive(true);
        title.GetComponent<SpriteRenderer>().DOFade(0, 0);
        title.GetComponent<SpriteRenderer>().DOFade(1, 0.5f).OnComplete(() =>
        {
            ...
            for (int i = 0; i < title.transform.childCount; i++)
            {
                ...
                letter.GetComponent<SpriteRenderer>().DOFade(1, 0.5f).SetDelay(i * 0.2f);
            }
        });
        ...
        subTitle.GetComponent<SpriteRenderer>().DOFade(1, 0.5f).OnComplete(() =>
        {
        ...
        buttons.GetComponent<CanvasGroup>().DOFade(1, 0.5f).OnComplete(() =>
        {
            // Buttons 클릭 가능
